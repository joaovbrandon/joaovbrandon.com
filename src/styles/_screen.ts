 ...
 *
 * @example `@media ${screen.max.xs} { display: none; }`
 * @example `@media ${screen.min.sm} { display: none; }`
 * @example `@media ${screen.min.md} and ${screen.max.md} { display: none; }`
 *
 * Breakpoints was inspired in Bootstrap v4.3!
 * {@link https://getbootstrap.com/docs/4.3/layout/overview/}
 */
